...
export default function Home() {
  ...
  useEffect(() => {
    ...
    const unsubscribe = onSnapshot(q, (snapshot) => {
      ...
      setFeaturedProjectsError("Failed to load featured projects. Please check your internet connection or Firebase permissions.");
  ...
  return (
    ...
    <main className="flex flex-col min-h-screen bg-gray-50 text-gray-800">
      ...
      <section className="relative flex flex-col items-center justify-center text-center py-24 px-4 bg-slate-900 text-white overflow-hidden flex-shrink-0">
        ...
        <div className={`z-10 max-w-4xl mx-auto transition-opacity duration-1000 ${isVisible ? 'opacity-100' : 'opacity-0'}`}>
          <Image
      ...
      <section className="py-20 px-4 bg-white text-gray-800 flex-shrink-0">
        <div className="container mx-auto max-w-4xl text-center">
          <Rocket size={64} className="text-indigo-600 mx-auto mb-6 animate-bounce-subtle" />
          <h2 className="text-4xl font-bold mb-6">Who We Are: Your Digital Architects</h2>
          <p className="text-lg leading-relaxed mb-4">
            Atomicity Web Works is more than just a web agency; we are your strategic partners in the digital realm. We specialize in transforming visionary concepts into robust, scalable, and user-centric web applications that don't just exist, but truly thrive.
          </p>
          <p className="text-lg leading-relaxed">
            Our passion lies in the meticulous craft of code and design, ensuring every project is a masterpiece of precision and performance. From captivating user interfaces to powerful backend infrastructures, we build digital experiences that are tailored to elevate your brand and drive tangible business growth.
          </p>
          <Link href="/about" className="mt-8 px-6 py-3 border-2 border-indigo-600 text-indigo-600 font-semibold rounded-lg hover:bg-indigo-600 hover:text-white transition duration-300 inline-block">
            Uncover Our Story
          </Link>
        </div>
      </section>
      ...
      <section className="py-20 px-4 bg-slate-800 text-white flex-shrink-0">
        <div className="container mx-auto max-w-6xl">
          <h2 className="text-4xl font-bold text-center mb-12">Our Core Expertise</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {/* Expertise Card 1 */}
            <div className="bg-slate-700 p-8 rounded-lg shadow-md text-center hover:shadow-xl transition duration-300 transform hover:-translate-y-2">
              ...
              <h3 className="text-2xl font-semibold mb-3">Custom Web Development</h3>
              <p className="text-gray-200">
                Bespoke web applications built from the ground up to meet your exact specifications and business logic.
              </p>
            </div>
            {/* Expertise Card 2 */}
            <div className="bg-slate-700 p-8 rounded-lg shadow-md text-center hover:shadow-xl transition duration-300 transform hover:-translate-y-2">
              ...
              <p className="text-gray-200">
                Powerful online stores designed for seamless user experience and maximum conversions.
              </p>
            </div>
            {/* Expertise Card 3 */}
            <div className="bg-slate-700 p-8 rounded-lg shadow-md text-center hover:shadow-xl transition duration-300 transform hover:-translate-y-2">
              <Brain size={48} className="text-purple-400 mx-auto mb-4" />
              <h3 className="text-2xl font-semibold mb-3">AI & Automation Integrations</h3>
              <p className="text-gray-200">
                Leverage artificial intelligence and automation to streamline operations and enhance user engagement.
              </p>
            </div>
            {/* Expertise Card 4 */}
            <div className="bg-slate-700 p-8 rounded-lg shadow-md text-center hover:shadow-xl transition duration-300 transform hover:-translate-y-2">
              <LayoutDashboard size={48} className="text-green-400 mx-auto mb-4" />
              <h3 className="2xl font-semibold mb-3">Intuitive Admin Panels</h3>
              <p className="text-gray-200">
                Empower your team with custom, easy-to-use dashboards for complete control over your content and data.
              </p>
            </div>
            {/* Expertise Card 5 */}
            <div className="bg-slate-700 p-8 rounded-lg shadow-md text-center hover:shadow-xl transition duration-300 transform hover:-translate-y-2">
              <ShieldCheck size={48} className="text-yellow-400 mx-auto mb-4" />
              <h3 className="text-2xl font-semibold mb-3">Security & Optimization</h3>
              <p className="text-gray-200">
                Building secure, high-performance websites optimized for speed and search engine visibility.
              </p>
            </div>
            {/* Expertise Card 6 */}
            <div className="bg-slate-700 p-8 rounded-lg shadow-md text-center hover:shadow-xl transition duration-300 transform hover:-translate-y-2">
              ...
              <p className="text-gray-200">
                Crafting engaging and intuitive user journeys that keep your audience captivated.
              </p>
            </div>
          </div>
          <div className="text-center mt-12">
            <Link href="/services" className="px-8 py-3 border-2 border-indigo-600 text-indigo-600 font-semibold rounded-lg hover:bg-indigo-600 hover:text-white transition duration-300 inline-block">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="bg-white p-6 rounded-lg shadow-md text-center hover:shadow-xl transition duration-300">
              ...
              <p className="text-gray-600">
                We stay ahead of the curve, integrating the latest technologies to give you a competitive edge.
              </p>
            </div>
            {/* Commitment Card 2 */}
            <div className="bg-white p-6 rounded-lg shadow-md text-center hover:shadow-xl transition duration-300">
              <Handshake size={48} className="text-green-600 mx-auto mb-4" />
              <h3 className="text-2xl font-semibold mb-3">Partnership Approach</h3>
              <p className="text-gray-600">
                We work hand-in-hand with you, ensuring transparency and collaboration from concept to launch.
              </p>
            </div>
            {/* Commitment Card 3 */}
            <div className="bg-white p-6 rounded-lg shadow-md text-center hover:shadow-xl transition duration-300">
              <TrendingUp size={48} className="text-red-600 mx-auto mb-4" />
              <h3 className="text-2xl font-semibold mb-3">Results-Driven Focus</h3>
              <p className="text-gray-600">
                Our ultimate goal is to deliver digital products that achieve your business objectives and drive growth.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-20 px-4 bg-slate-900 text-white text-center flex-shrink-0">
        <div className="container mx-auto max-w-3xl">
          ...
          <p className="text-xl mb-8 opacity-90">
            Let's discuss your project and turn your ideas into a powerful online presence.
          </p>
