...
export async function POST(request) {
  try {
    ...
    const contactCollectionRef = collection(db, `artifacts/${appId}/public/data/contact_submissions`);
    ...
    return new Response(JSON.stringify({ error: 'Internal Server Error. Could not send message.' }), {
