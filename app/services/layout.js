...
export const metadata = {
  ...
  description: 'Explore the comprehensive digital solutions offered by Atomicity Web Works, including custom web development, e-commerce, UI/UX design, SEO, and AI integration.',
};
