    ...
    return (
      <div className="min-h-[calc(100vh-120px)] flex flex-col items-center justify-center bg-gray-50 py-12 px-4">
        ...
        <p className="text-lg text-gray-700 text-center">
          The project ID provided does not match any records.
        </p>
        ...
        {project.imageUrl && (
          <Image
            ...
            onError={(e) => {
              ...
              e.target.src =
                "https://placehold.co/800x500/cccccc/000000?text=Image+Error";
            }}
          />
        )}
          ...
          <div className="mb-8">
            ...
            <div className="flex flex-wrap gap-3">
              {project.technologies.map((tech, index) => (
                <span
                  key={index}
                  className="bg-blue-100 text-blue-800 text-md font-semibold px-4 py-2 rounded-full shadow-sm"
                >
                  {tech}
                </span>
              ))}
