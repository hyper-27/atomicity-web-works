  ...
  const mockProjects = [
    {
      ...
      description:
        "A modern and responsive e-commerce platform built for a boutique fashion brand, focusing on seamless user experience and secure transactions.",
      imageUrl:
        "https://placehold.co/600x400/000000/FFFFFF?text=E-commerce+Project", // <--- CHECK THIS EXACTLY
      projectUrl: "#",
    ...
    },
    {
      ...
      description:
        "Developed an intuitive and powerful SaaS dashboard for a data analytics startup, providing real-time insights and customizable reporting features.",
      imageUrl:
        "https://placehold.co/600x400/333333/FFFFFF?text=SaaS+Dashboard", // <--- CHECK THIS EXACTLY
      projectUrl: "#",
    ...
    },
    {
      ...
      description:
        "Crafted a sleek and dynamic online portfolio for a freelance graphic designer, showcasing their diverse work and enabling direct client inquiries.",
      imageUrl:
        "https://placehold.co/600x400/666666/FFFFFF?text=Portfolio+Site", // <--- CHECK THIS EXACTLY
      projectUrl: "#",
    ...
    const unsubscribe = onSnapshot(
      ...
      (snapshot) => {
        if (!snapshot.empty) {
          ...
          setMessage(
            "No projects found in the database. Displaying mock data.",
          );
          setError("");
        }
        setLoading(false);
      ...
      (err) => {
        ...
        setError(
          "Failed to load projects from our database. Displaying examples.",
        );
    ...
    <div className="min-h-[calc(100vh-120px)] flex flex-col items-center py-12 px-4 bg-gray-50">
      <div className="container mx-auto max-w-6xl">
        ...
        <p className="text-xl text-gray-700 text-center mb-12 max-w-3xl mx-auto">
          Explore a selection of our recent web development projects, showcasing
          our expertise and diverse capabilities across various industries.
        </p>
