      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 w-full max-w-4xl">
        <div className="bg-white p-6 rounded-lg shadow-md hover:shadow-lg transition duration-300">
          ...
          <p className="text-gray-600">
            Add, edit, or remove client projects and design examples.
          </p>
          <Link
            href="/admin/projects"
            className="mt-4 px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition duration-300 inline-block"
          >
            Go to Projects
          </Link>
        </div>
        ...
        <div className="bg-white p-6 rounded-lg shadow-md hover:shadow-lg transition duration-300">
          ...
          <p className="text-gray-600">
            Curate and display client testimonials.
          </p>
          <Link
        ...
        <div className="bg-white p-6 rounded-lg shadow-md hover:shadow-lg transition duration-300">
          ...
          <p className="text-gray-600">
            View and manage messages received from your contact form.
          </p>
          <Link
            href="/admin/submissions"
            className="mt-4 px-4 py-2 bg-indigo-600 text-white rounded-lg hover:bg-indigo-700 transition duration-300 inline-block"
          >
            View Submissions
          </Link>
        </div>
        ...
        <div className="bg-white p-6 rounded-lg shadow-md hover:shadow-lg transition duration-300">
          ...
          <p className="text-gray-600">
            Generate and manage verifiable internship/program certificates.
          </p>
          <Link
            href="/admin/certificates"
            className="mt-4 px-4 py-2 bg-purple-600 text-white rounded-lg hover:bg-purple-700 transition duration-300 inline-block"
          >
            Go to Certificates
          </Link>
        </div>
        ...
        <div className="bg-white p-6 rounded-lg shadow-md hover:shadow-lg transition duration-300">
          ...
          <p className="text-gray-600">
            Upload and showcase private design mockups for clients.
          </p>
