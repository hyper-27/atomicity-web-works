    ...
    <div className="min-h-[calc(100vh-120px)] flex items-center justify-center bg-gray-100 p-4">
      <div className="bg-white p-8 rounded-lg shadow-xl w-full max-w-md">
        ...
        <div className="space-y-6">
          ...
          <form onSubmit={handleEmailPasswordLogin}> {/* Corrected onSubmit */}
            <h2 className="text-xl font-semibold text-gray-800 mb-4">Login with Email & Password</h2>
            <div className="mb-4">
              <label htmlFor="email-password" className="block text-gray-700 text-sm font-bold mb-2">
                Email Address
              </label>
              <input
                type="email"
          ...
          <form onSubmit={handleSendSignInLink}>
            <h2 className="text-xl font-semibold text-gray-800 mb-4">Login with Magic Link</h2>
            <div className="mb-4">
              <label htmlFor="email-magic" className="block text-gray-700 text-sm font-bold mb-2">
                Email Address
              </label>
              <input
                type="email"
