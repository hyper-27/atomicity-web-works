    ...
    <div className="min-h-[calc(100vh-120px)] flex flex-col items-center py-12 px-4 bg-gray-50">
      ...
      <div className="container mx-auto max-w-6xl">
        ...
        <p className="text-xl text-gray-700 text-center mb-12 max-w-3xl mx-auto">
          Have a project in mind, a question, or just want to say hello? We'd love to hear from you! Reach out via the form below or our direct contact details.
        </p>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 bg-white p-8 rounded-lg shadow-xl">
          ...
          <div className="flex flex-col justify-center space-y-8">
            ...
            <div className="flex items-center space-x-4">
              ...
              <div>
                ...
                <a href="mailto:contact@atomicitywebworks.com" className="text-blue-600 hover:underline">contact@atomicitywebworks.com</a>
              </div>
            </div>
            <div className="flex items-center space-x-4">
              ...
              <div>
                ...
                <a href="tel:+919876543210" className="text-blue-600 hover:underline">+91 98765 43210</a> {/* Replace with your actual number */}
              </div>
            </div>
            <div className="flex items-center space-x-4">
              ...
              <div>
                ...
                <p className="text-gray-700">123 Web Street, Digital City, Bhopal, MP, India</p> {/* Replace with your actual address */}
              </div>
            </div>
          ...
          <div className="flex flex-col">
            ...
            {submitMessage && (
              <p className={`p-3 rounded-md mb-4 text-center ${isError ? 'bg-red-100 text-red-700' : 'bg-green-100 text-green-700'}`}>
                {submitMessage}
              </p>
            )}
