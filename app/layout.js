...
export const metadata = {
  ...
  description:
    "Atomicity Web Works is a leading web agency specializing in custom web development, e-commerce solutions, UI/UX design, SEO, and AI integrations. We build robust, scalable and user-centric digital platforms that drive growth.",
  keywords:
    "web development, web design, e-commerce, UI/UX, SEO, AI integration, custom websites, digital agency, India, Bhopal, web solutions",
