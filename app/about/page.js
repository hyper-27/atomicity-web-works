      ...
      <div className="container mx-auto max-w-6xl bg-white p-8 md:p-12 rounded-xl shadow-lg">
        ...
        <section className="text-center mb-16">
          ...
          <p className="text-xl text-gray-700 max-w-3xl mx-auto">
            We are a dedicated web development agency committed to building
            precise, powerful, and pixel-perfect digital solutions for
        ...
        <section className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center mb-16">
          <div className="order-2 md:order-1">
            ...
            <p className="text-lg text-gray-700 leading-relaxed mb-4">
              ...
              excellence, Atomicity Web Works began with a simple goal: to
              transform ideas into impactful online experiences. We believe that
              a strong digital presence is the cornerstone of modern business
              success.
            </p>
            <p className="text-lg text-gray-700 leading-relaxed">
              Our mission is to empower businesses by crafting bespoke web
              solutions that are not only visually stunning but also highly
              functional, scalable, and secure. We aim to be your trusted
              partner in navigating the complex digital landscape.
            </p>
          </div>
          <div className="order-1 md:order-2 flex justify-center">
            ...
            <Image
              ...
              onError={(e) => {
                ...
                e.target.src =
                  "https://placehold.co/500x350/cccccc/000000?text=Image+Error";
              }}
            />
          </div>
        </section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-blue-50 p-6 rounded-lg shadow-sm text-center transform transition-transform duration-300 hover:scale-105 hover:shadow-md">
              ...
              <p className="text-gray-700 text-sm">
                ...
                creative approaches to deliver cutting-edge solutions.
              </p>
            </div>
            <div className="bg-green-50 p-6 rounded-lg shadow-sm text-center transform transition-transform duration-300 hover:scale-105 hover:shadow-md">
              ...
              <p className="text-gray-700 text-sm">
                Excellence is non-negotiable. We build robust, reliable, and
            ...
            <div className="bg-purple-50 p-6 rounded-lg shadow-sm text-center transform transition-transform duration-300 hover:scale-105 hover:shadow-md">
              ...
              <p className="text-gray-700 text-sm">
                Your vision is our priority. We collaborate closely to ensure
        ...
        <section className="text-center mb-16">
          ...
          <div className="flex flex-col md:flex-row justify-center items-center md:space-x-8 space-y-8 md:space-y-0">
            <div className="bg-gray-100 p-6 rounded-lg shadow-md w-full md:w-1/3 max-w-sm">
              ...
              <p className="text-gray-700 text-sm">
                Passionate about creating robust and intuitive web applications
        ...
        <section className="mb-16 text-center">
          <h2 className="text-4xl font-bold text-gray-800 mb-10">
            Why Choose Atomicity Web Works?
          </h2>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            <div className="bg-indigo-50 p-6 rounded-lg shadow-sm flex items-start text-left">
              ...
              <div>
                ...
                <p className="text-gray-700 text-sm">
                  Years of experience in modern web technologies, delivering
            ...
            <div className="bg-indigo-50 p-6 rounded-lg shadow-sm flex items-start text-left">
              ...
              <div>
                ...
                <p className="text-gray-700 text-sm">
                  ...
                  custom-built to meet your unique business needs.
                </p>
              </div>
            </div>
            <div className="bg-indigo-50 p-6 rounded-lg shadow-sm flex items-start text-left">
              ...
              <div>
                ...
                <p className="text-gray-700 text-sm">
                  From concept to launch, we keep you informed every step of the
                  way with clear communication.
                </p>
              </div>
            </div>
            <div className="bg-indigo-50 p-6 rounded-lg shadow-sm flex items-start text-left">
        ...
        <section className="text-center bg-blue-600 text-white p-10 rounded-lg shadow-lg">
          ...
          <p className="text-lg mb-6">
            Let's discuss your next project and bring your digital vision to
            life.
          </p>
          <Link
            href="/contact"
            className="inline-block bg-white text-blue-600 font-bold px-8 py-4 rounded-full shadow-md hover:bg-gray-100 transform hover:scale-105 transition duration-300"
          >
