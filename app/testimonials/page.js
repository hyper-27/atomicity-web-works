  ...
  const mockTestimonials = [
    {
      id: "mock_t1",
      quote:
        "Atomicity Web Works transformed our online presence. Their attention to detail and commitment to quality is unparalleled!",
    ...
    },
    {
      id: "mock_t2",
      quote:
        "The team at Atomicity delivered an intuitive e-commerce platform that exceeded our expectations. Highly recommend!",
    ...
    },
    {
      id: "mock_t3",
      quote:
        "Their expertise in custom web development is truly impressive. They turned our complex ideas into a seamless reality.",
    ...
    },
    {
      id: "mock_t4",
      quote:
        "We had a great experience working with Atomicity. Their support was excellent throughout the project.",
    ...
    const unsubscribe = onSnapshot(
      ...
      (snapshot) => {
        if (!snapshot.empty) {
          ...
          setMessage(
            "No approved testimonials found in the database. Displaying examples.",
          );
          setError("");
        }
        setLoading(false);
      ...
      (err) => {
        ...
        setError(
          "Failed to load testimonials from our database. Displaying examples.",
        );
    ...
    <div className="min-h-[calc(100vh-120px)] flex flex-col items-center py-12 px-4 bg-gray-50">
      <div className="container mx-auto max-w-6xl">
        ...
        <p className="text-xl text-gray-700 text-center mb-12 max-w-3xl mx-auto">
          ...
          working with Atomicity Web Works and the impact we've made.
        </p>
        ...
        {loading ? (
          ...
          <p className="text-center text-gray-600 text-lg">
            No testimonials to display yet. Check back soon!
          </p>
        ) : (
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {testimonials.map((testimonial) => (
              <div
                key={testimonial.id}
                className="bg-white p-8 rounded-lg shadow-lg flex flex-col transform hover:scale-105 transition duration-300"
              >
                  ...
                  {testimonial.clientImageUrl && (
                    <Image
                      ...
                      onError={(e) => {
                        ...
                        e.target.src =
                          "https://placehold.co/64x64/cccccc/000000?text=Client";
                      }}
                    />
                  )}
                  <div>
        ...
        <div className="text-center mt-16">
          ...
          <p className="text-lg text-gray-600 mb-8 max-w-2xl mx-auto">
            We love hearing from our clients! If you've had a great experience
            with Atomicity Web Works, we'd be thrilled to feature your
            testimonial.
          </p>
          <Link
            href="/contact"
